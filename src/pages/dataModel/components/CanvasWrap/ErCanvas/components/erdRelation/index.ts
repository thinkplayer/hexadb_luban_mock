...
Graph.registerMarker("relation", (args) => {
  ...
  const x = 4;
  const y = 0;
  const relationArrow: any = {
    n: `M${x + 2 * r + 1},${y - r}a ${r},${r},0,1,1,0,${
      2 * r
    }a ${r},${r},0,1,1,0,${-2 * r}M ${x + r + 1},${r + 1}L ${x + r + 1},${
      -r - 1
    }M ${x + r + 1},${y}L ${y},-${r}M ${x + r + 1},${y}L ${y},${r} z`,
    "0,1": `M${x + 2 * r + 1},${y - r}a ${r},${r},0,1,1,0,${
      2 * r
    }a ${r},${r},0,1,1,0,${-2 * r}M ${x + r + 1},${r + 1}L ${x + r + 1},${
      -r - 1
    } z`,
    "0,n": `M${x + 2 * r + 1},${y - r}a ${r},${r},0,1,1,0,${
      2 * r
    }a ${r},${r},0,1,1,0,${-2 * r}M ${x + r + 1},${r + 1}L ${x + r + 1},${
      -r - 1
    }M ${x + r + 1},${y}L ${y},-${r}M ${x + r + 1},${y}L ${y},${r} z`,
    1: `M ${x + r + 1},${r + 1}L ${x + r + 1},${-r - 1} z`,
    "1,n": `M ${x + r + 1},${r + 1}L ${x + r + 1},${-r - 1}M ${
      x + r + 1
    },${y}L ${y},-${r}M ${x + r + 1},${y}L ${y},${r} z`,
    0: `M${x},${y - r}a ${r},${r},0,1,1,0,${2 * r}a ${r},${r},0,1,1,0,${
      -2 * r
    }`,
